...
function TotalPembayranFO(props) {
    ...
    >
      ...
      <Modal.Body  >
        ...
        <Card className='p-2 m-3' >
               <div className="row mb-3">
              <div className="col-sm fs-6">
              <p> JIKA GRUP : Total Jumlah Pembayaran Yang Dibayarkan sebesar 50% dari Total jumlah Pembayaran : Rp.{(((total+totalF)+((total+totalF) * 0.10))/2).toLocaleString()} </p>
...
export default TotalPembayranFO
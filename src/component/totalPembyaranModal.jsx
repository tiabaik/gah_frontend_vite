...
import DetailBayar from './detailBayar';



function TotalPembayranModal(props) {
    ...
    >
      ...
      <Modal.Body  >
        ...
        <Card className='p-2 m-3' >
              ...
              <Button className="ms-3 float-end" style={{ backgroundColor: '#4caf50', borderColor: '#4caf50', textAlign: 'left' }} onClick={() => passIdB(props.id)}>
                    BAYAR
              </Button>
              </div>
      </div>     
      ...
      <DetailBayar
                id={idB}
                total={(total+totalF)+((total+totalF) * 0.10)}
                show={modalShowB}
...
export default TotalPembayranModal
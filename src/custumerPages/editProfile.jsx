...
function EditProfile () {
      ...
      const handleSubmit = (event) => {
          ...
          axios.put('/custumer', data,{
            ...
            .then(response => {
                  console.log(response)
                  toast.update(id, {render: "Successfully Edit Data", type: "success", isLoading:false, autoClose: 3000,})
                  navigate("/profile")
          ...
          <Card.Body>
            <Form noValidate validated={validated} onSubmit={handleSubmit}>
              <Form.Group controlId="validationCustom01">
                ...
                <Form.Control required type="text" placeholder="Nama" value={nama} onChange={(e) => {setNama(e.target.value)}} />
